...
└── patterns/                      # Reusable technical patterns
    ...
    ├── redis-session-strategy.md  # Session management
    ├── rate-limiting.md           # Request throttling
    ├── docker-compose-setup.md    # Multi-service orchestration
    └── database-migrations.md     # Schema version control
```
...
- **Need security patterns?** → `/patterns/csrf-implementation.md`
- **Need Docker setup?** → `/patterns/docker-compose-setup.md`
- **Need session management?** → `/patterns/redis-session-strategy.md`
- **Want to see full architecture?** → `/projects/ecommerce-cosmetics/`
